...
def main() -> None:
    ...
    parser.add_argument("--visualize", dest="visualize", action="store_true", help=argparse.SUPPRESS)
    parser.add_argument("--headless", dest="visualize", action="store_false", help="Disable the native simulator viewer")
